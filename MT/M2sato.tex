...
\item $V_A$，$V_B$に対する頂点ラベリングの値はそれぞれ$x$，$y$のみに依存して決定される．%ほんと?
...
グラフに与えられている独立集合が2-MISでないと仮定する．
このとき，ある2点を取り除くことで独立集合に追加できる3点が存在する．
...
また，1-MIS問題が小定数$\epsilon > 0$に対して$\Omega(n^{\epsilon})$ラウンドの下界を持つかどうかは未解決であるが，
